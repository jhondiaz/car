...
public class NotificationScheduler
{
    ...
    public static void setReminder(Context context,Class<?> cls,Calendar setcalendar,int _id,String content)
    {
    ...
    public static void cancelReminder(Context context,Class<?> cls,int _id)
    {
        // Disable a receiver
    ...
    public static void showNotification(Context context,Class<?> cls,String title,String content)
    {
        ...
        Notification notification = builder.setContentTitle(title)
                ...
                .setAutoCancel(true)
                .setSound(alarmSound)
                .setSmallIcon(R.mipmap.ic_soporte)
